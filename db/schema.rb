...
ActiveRecord::Schema[8.1].define(version: 2026_07_19_134508) do
  ...
  create_table "product_exceptions", force: :cascade do |t|
    ...
    t.index ["product_id", "date"], name: "index_product_exceptions_on_product_id_and_date", unique: true
    t.index ["product_id"], name: "index_product_exceptions_on_product_id"
  end
  ...
  add_foreign_key "product_exceptions", "products"
